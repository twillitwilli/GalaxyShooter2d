...
////// Emissive:
                ...
                fixed4 finalRGBA = fixed4(finalColor,(pow(i.vertexColor.a,_vertColorDensity)*(pow(lerp( node_5474, _MainTex_var.a, _haveAlpha ),_alphaDensity)*_alphaPower)));
